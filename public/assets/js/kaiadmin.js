...
// Mengganti logo dengan teks Dewa Motor
var logoHeaderContent =
    '<a href="index.html" class="logo"><h1 class="navbar-brand" style="color: #fff; font-size: 20px; font-weight: bold; margin: 0;">Dewa Motor</h1></a>';
$(".sidebar .logo-header").html(logoHeaderContent);
