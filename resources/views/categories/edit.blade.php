...
@section('content')
<!-- Card Container untuk Form Edit Kategori -->
<div class="card">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="6">{{ old('description', $category->description) }}</textarea>
                    </div>
                </div>
            </div>
